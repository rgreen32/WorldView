...
var GlobeLayerKapsule = Kapsule({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE.LineSegments(
  ...
  update: function update(state, changedProps) {
    ...
    if (changedProps.hasOwnProperty("bumpImageUrl")) {
      if (!state.bumpImageUrl) {
        ...
        state.bumpImageUrl &&
          new THREE.TextureLoader().load(state.bumpImageUrl, function(texture) {
...
var PointsLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    var pointGeometry = new THREE$1[
      state.pointsMerge ? "CylinderGeometry" : "CylinderBufferGeometry"
    ](1, 1, 1, state.pointResolution)
    ...
    function updateObj(obj, d) {
      var applyUpdate = function applyUpdate(td) {
        ...
        var globeCenter = state.pointsMerge
          ? new THREE$1.Vector3(0, 0, 0)
          : state.scene.localToWorld(new THREE$1.Vector3(0, 0, 0)) // translate from local to world coords
      ...
      var currentTargetD =
        obj.__currentTargetD ||
        Object.assign({}, targetD, {
          alt: -1e-3
        })

      if (
        Object.keys(targetD).some(function(k) {
        ...
        if (
          ...
          state.pointsTransitionDuration < 0
        ) {
          // set final position
          applyUpdate(targetD)
        } else {
...
var setAttributeFn = new THREE$2.BufferGeometry().setAttribute
  ? "setAttribute"
  : "addAttribute"
var gradientShaders = {
  uniforms: {
...
var ArcsLayerKapsule = Kapsule({
    ...
    new FrameTicker().onTick.add(function(_, timeDelta) {
      state.arcsData
        .filter(function(d) {
          return (
            d.__threeObj &&
            d.__threeObj.material &&
            d.__threeObj.__dashAnimateStep
          )
        })
        .forEach(function(d) {
          var obj = d.__threeObj
  ...
  update: function update(state) {
    ...
    var sharedMaterial = new THREE$2.ShaderMaterial(
      _objectSpread2({}, gradientShaders, {
        transparent: true,
    ...
    threeDigest(state.arcsData, state.scene, {
      createObj: function createObj(arc) {
        ...
        var obj = useTube
          ? new THREE$2.Mesh()
          : new THREE$2.Line(new THREE$2.BufferGeometry())
      ...
      updateObj: function updateObj(obj, arc) {
        ...
        obj.geometry[setAttributeFn](
          "vertexRelDistance",
          vertexRelDistanceArray
        )
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          if (useTube) {
            ...
            obj.geometry = new THREE$2.TubeBufferGeometry(
              curve,
              state.arcCurveResolution,
              stroke / 2,
              state.arcCircularResolution
            )
            obj.geometry[setAttributeFn]("vertexColor", vertexColorArray)
            obj.geometry[setAttributeFn](
              "vertexRelDistance",
            ...
            obj.geometry.setFromPoints(
              curve.getPoints(state.arcCurveResolution)
            )
          }
        }
        ...
        if (
          ...
          if (
            !state.arcsTransitionDuration ||
            state.arcsTransitionDuration < 0
          ) {
            // set final position
            applyUpdate(targetD)
          } else {
    ...
    function calcCurve(_ref) {
      ...
      if (altitude) {
        ...
        var curve = _construct(
          THREE$2.CubicBezierCurve3,
          _toConsumableArray([startPnt, m1Pnt, m2Pnt, endPnt].map(getVec))
        ...
        return calcSphereArc.apply(
          void 0,
          _toConsumableArray(
            [[].concat(startPnt, [_alt]), [].concat(endPnt, [_alt])].map(getVec)
          )
        )
      } //
    ...
    function calcColorVertexArray(colors, numSegments) {
      ...
      var vertexColorArray = new THREE$2.Float32BufferAttribute(
        numVerticesGroup * 4 * numVerticesPerSegment,
        4
      )
...
var HexBinLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    var byH3Idx = indexBy(
      state.hexBinPointsData.map(function(d) {
    ...
    if (state.hexBinMerge) {
      ...
      var hexPoints = new THREE$3.Mesh(
        hexPointsGeometry,
        new THREE$3.MeshBasicMaterial({
          color: 0xffffff,
    ...
    function updateObj(obj, d) {
      var GeometryClass = state.hexBinMerge
        ? ConicPolygonGeometry
        : ConicPolygonGeometry
      ...
      var applyUpdate = function applyUpdate(td) {
        ...
        var geoJson =
          margin === 0
            ? obj.__hexGeoJson
            : obj.__hexGeoJson.map(function(_ref4) {
        ...
        obj.geometry = new GeometryClass(
          [geoJson],
          GLOBE_RADIUS,
          GLOBE_RADIUS * (1 + alt),
          false
      ...
      if (
        ...
        if (
          state.hexBinMerge ||
          !state.hexTransitionDuration ||
          state.hexTransitionDuration < 0
        ) {
          // set final position
          applyUpdate(targetD)
        } else {
    ...
    threeDigest(singlePolygons, state.scene, {
      ...
      updateObj: function updateObj(obj, _ref) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          addStroke &&
            (strokeObj.geometry = new GeoJsonGeometry(
              geoJsonGeometry,
              GLOBE_RADIUS * (1 + alt + 1e-4)
            )) // stroke slightly above the conic mesh
        }
        ...
        if (
          ...
          if (
            !state.polygonsTransitionDuration ||
            state.polygonsTransitionDuration < 0
          ) {
            // set final position
            applyUpdate(targetD)
          } else {
    ...
    threeDigest(state.hexPolygonsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (geoJson.type === "Polygon") {
          h3Idxs.push.apply(
            h3Idxs,
            _toConsumableArray(polyfill(geoJson.coordinates, h3Res, true))
          )
        } else if (geoJson.type === "MultiPolygon") {
          geoJson.coordinates.forEach(function(coords) {
            return h3Idxs.push.apply(
              h3Idxs,
              _toConsumableArray(polyfill(coords, h3Res, true))
            )
          })
        } else {
          console.warn(
            ...
            updateObj: function updateObj(obj) {
              ...
              var applyUpdate = function applyUpdate(td) {
                ...
                var geoJson =
                  margin === 0
                    ? obj.__hexGeoJson
                    : obj.__hexGeoJson.map(function(_ref2) {
                        var _ref3 = _slicedToArray(_ref2, 2),
                          elng = _ref3[0],
                          elat = _ref3[1]
              ...
              if (
                ...
                if (
                  !state.hexPolygonsTransitionDuration ||
                  state.hexPolygonsTransitionDuration < 0
                ) {
                  // set final position
                  applyUpdate(targetD)
                } else {
...
function interpolateVectors(fromPnts, toPnts) {
  var extendArr = function extendArr(arr, length) {
    ...
    return [].concat(
      ...
      _toConsumableArray(
        _toConsumableArray(new Array(length - arr.length)).map(function() {
          return repeatItem
        })
      )
    )
  ...
  var interpolator = interpolateArray.apply(
    void 0,
    _toConsumableArray(
      [fromPnts, toPnts]
        .map(function(pnts) {
  ...
  return function(k) {
    return k === 0
      ...
      : k === 1
      ? toPnts
      : interpolator(k).map(function(_ref2) {
          var _ref3 = _slicedToArray(_ref2, 3),
            x = _ref3[0],
            y = _ref3[1],
            z = _ref3[2]
...
var setAttributeFn$1 = new THREE$7.BufferGeometry().setAttribute
  ? "setAttribute"
  : "addAttribute"
...
var PathsLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    var sharedShaderMaterial = new THREE$7.ShaderMaterial(
      _objectSpread2({}, gradientShaders$1, {
        transparent: true,
    ...
    threeDigest(state.pathsData, state.scene, {
      ...
      updateObj: function updateObj(obj, path) {
        ...
        if (!useFatLine) {
          ...
          obj.__dashAnimateStep =
            dashAnimateTime > 0 ? 1000 / dashAnimateTime : 0 // per second
          // set dash uniforms
        ...
        var pointsInterpolator = interpolateVectors(
          (path.__currentTargetD && path.__currentTargetD.points) || [
            points[0]
          ],
          points
        )
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          var kPoints = (path.__currentTargetD.points = pointsInterpolator(
            interpolK
          ))
        ...
        var currentTargetD = Object.assign(
          {},
          path.__currentTargetD || targetD,
          {
            interpolK: 0
          }
        )
        ...
        if (
          ...
          if (
            !state.pathTransitionDuration ||
            state.pathTransitionDuration < 0
          ) {
            // set final position
            applyUpdate(targetD)
          } else {
    ...
    function calcPath(
      ...
      var getInterpolatedVals = function getInterpolatedVals(
        start,
        end,
        numPnts
      ) {
      ...
      var interpolateLine = function interpolateLine() {
        ...
        lineCoords.forEach(function(pnt) {
          if (prevPnt) {
            var dist = Math.sqrt(
              Math.pow(pnt[0] - prevPnt[0], 2) +
                Math.pow(pnt[1] - prevPnt[1], 2)
            )

            if (dist > maxDegDistance) {
              var numAdditionalPnts = Math.floor(dist / maxDegDistance)
              var lats = getInterpolatedVals(
                prevPnt[0],
                pnt[0],
                numAdditionalPnts
              )
              var lngs = getInterpolatedVals(
                prevPnt[1],
                pnt[1],
                numAdditionalPnts
              )
              var alts = getInterpolatedVals(
                prevPnt[2],
                pnt[2],
                numAdditionalPnts
              )
    ...
    function calcColorVertexArray(colors, numSegments) {
      ...
      var vertexColorArray = new THREE$7.Float32BufferAttribute(
        numVerticesGroup * numArgs * numVerticesPerSegment,
        numArgs
      )
      ...
      for (var v = 0, l = numVerticesGroup; v < l; v++) {
        ...
        for (var s = 0; s < numVerticesPerSegment; s++) {
          vertexColorArray.set(
            _vertexColor,
            (v * numVerticesPerSegment + s) * numArgs
          )
        }
      }
    ...
    threeDigest(state.labelsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (
          ...
          if (
            !state.labelsTransitionDuration ||
            state.labelsTransitionDuration < 0
          ) {
            // set final position
...
var linkedGlobeLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    ["globeImageUrl", "bumpImageUrl", "showAtmosphere", "showGraticules"].map(
      function(p) {
...
var linkedPointsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "pointsData",
...
var linkedArcsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "arcsData",
...
var linkedHexBinLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "hexBinPointsData",
...
var bindHexedPolygonsLayer = linkKapsule(
  "hexedPolygonsLayer",
  HexedPolygonsLayerKapsule
)
var linkedHexedPolygonsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "hexPolygonsData",
...
var linkedPolygonsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "polygonsData",
...
var linkedPathsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "pathsData",
...
var linkedLabelsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      "labelsData",
...
var linkedCustomLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
...
var Globe = Kapsule({
  ...
  init: function init(threeObj, state, _ref10) {
    var _ref10$animateIn = _ref10.animateIn,
      animateIn = _ref10$animateIn === void 0 ? true : _ref10$animateIn,
      _ref10$waitForGlobeRe = _ref10.waitForGlobeReady,
      waitForGlobeReady =
        _ref10$waitForGlobeRe === void 0 ? true : _ref10$waitForGlobeRe
    var _ref10$onReady = _ref10.onReady,
      onReady = _ref10$onReady === void 0 ? null : _ref10$onReady
    // Clear the scene
    emptyObject(threeObj) // Main three object to manipulate
...
function fromKapsule(kapsule) {
  var baseClass =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Object
    ...
    (function(_baseClass) {
      ...
      function FromKapsule() {
        ...
        _this = _possibleConstructorReturn(
          this,
          (_getPrototypeOf2 = _getPrototypeOf(FromKapsule)).call.apply(
            _getPrototypeOf2,
            [this].concat(args)
          )
        )
        _this.__kapsuleInstance = kapsule
          .apply(void 0, args)
          .apply(
            void 0,
            [].concat(
              _toConsumableArray(
                initKapsuleWithSelf ? [_assertThisInitialized(_this)] : []
              ),
              args
            )
          )
  ...
  Object.keys(kapsule()).forEach(function(m) {
    return (FromKapsule.prototype[m] = function() {
      ...
      var returnVal = (_this$__kapsuleInstan = this.__kapsuleInstance)[m].apply(
